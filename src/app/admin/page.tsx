          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-gray-900">Create Workshop</p>
                <p className="text-sm text-gray-500">Add a new workshop to the system</p>
              </div>
            </a>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <span className="absolute inset-0" aria-hidden="true" />
                <p className="text-sm font-medium text-gray-900">Manage Workshops</p>
                <p className="text-sm text-gray-500">View and edit existing workshops</p>
              </div>
            </a>
          </div>
        </div>
