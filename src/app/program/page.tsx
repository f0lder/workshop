...
const timelineData = [
  ...
  },
  {
	...
	conferenceLocation: 'Spitalul Universitar de Urgență Militar Central „Dr. Carol Davila"',
	conferences: [
		{ time: '8:30 - 9:15', speaker: 'DR. BLĂNARU TEODOR', title: 'Gastric Sleeve – succes terapeutic sau risc chirurgical?' },
		{ time: '9:15 - 9:30', break: 'Coffee break' },
		{ time: '9:30 - 10:15', speaker: 'DR. DIANA CHIȚIMUȘ', title: 'Terapiile genice în neurologia modernă: cum definim o boală rară?' },
		{ time: '10:15 - 10:30', break: 'Coffee break' },
		{ time: '10:30 - 11:30', speaker: 'DR. FELIX DOBRIȚOIU', title: 'Când roboții țin bisturiul' },
	],
	workshops: [
		...
		{ time: '14:00 - 16:00', instructor: 'Lt. Col. Med. Dr. Vladimir Zahiu', title: 'Asigurarea căii aeriene – o manevră cu potențial salvator de viață', location: 'Spitalul Universitar de Urgență Militar Central „Dr. Carol Davila"' },
		...
		{ time: '14:00 - 17:00', instructor: 'Conf. Univ. Dr. Vasile Balaban', title: 'Împingând limitele - Viitorul intervențiilor endoscopice', location: 'CIEH' },
		...
		{ time: '14:00 - 17:00', instructor: 'Asist. Univ. Dr. Alexandru Șerbăoiu', title: 'Radiologia Intervențională - de la Teorie la Practică', location: 'Secția clinică neurologie - Spitalul Universitar de Urgență Militar Central „Dr. Carol Davila"' },
